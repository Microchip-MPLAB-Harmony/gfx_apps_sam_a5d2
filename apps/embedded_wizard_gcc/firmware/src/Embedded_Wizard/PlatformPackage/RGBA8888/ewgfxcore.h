...
*   Font,
*   GlyphId  - Unique identification for the glyph. Useful to find glyphs within
...
*   The both additional font and glyph-id parameter serve for identification
*   purpose and simplify the reuse of already existing glyphs.
*
...
* ARGUMENTS:
*   aFont,
*   aGlyphId  - Unique identification for the glyph,
*   aOriginX,
...
*   the given font and id values. If no glyph could be found, the function
