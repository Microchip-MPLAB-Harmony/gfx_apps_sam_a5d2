...
![](../../../../docs/images/mhgs.png) blank\_cqs\_a5d2\_xu\_tm5000.X
...
The parent directory for this application is gfx/apps/blank\_canvas\_quickstart. To build this application, use MPLAB X IDE to open the gfx/apps/blank\_canvas\_quickstart/firmware/blank\_cqs\_a5d2\_xu\_tm5000.X project folder and press F11. 
...
|:-----------|:-------|:---------------------|:----------|
|blank\_cqs\_a5d2\_xu\_tm5000.X|SAM A5D2 Xplained Ultra|Legato Graphics w/ PDA TM5000 Display|SAM A5D2 Xplained Ultra with RGBA8888 GFX Interface and 5" WVGA PCAP Touch display|
